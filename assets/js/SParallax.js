(() => {
  ...
  bg1.addColorStop(0, `rgb(0, 0, 0)`); // 10 10 10
  bg1.addColorStop(.5, `rgb(0, 0, 0)`); // 10 10 20
  bg1.addColorStop(1, `rgb(0, 0, 0)`); // 30 10 40
  ...
  bg2.addColorStop(.45, `rgba(255, 0, 25, 0)`); //Проверить неродительские фоны
  bg2.addColorStop(.85, `rgba(9, 9, 25, 0)`);
  bg2.addColorStop(1, `rgba(0, 0, 20, 0)`);
